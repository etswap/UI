  ...
  const ChainInfo = [
    {
      ...
      chainName: NETWORK_CHAIN_ID === 65 ? "ETC Test Chain" : "ETC Chain Mainnet",
      nativeCurrency: {
        name: "ETC",
        symbol: "ETC",
        decimals: 18,
      },
      rpcUrls: [NETWORK_CHAIN_ID === 65 ? 'https://exchaintestrpc.okex.org' : 'https://www.ethercluster.com/etc'],
      blockExplorerUrls: [NETWORK_CHAIN_ID === 65 ? 'https://blockscout.com/etc/mainnet/' : 'https://blockscout.com/okexchain'],
    },
  ]
