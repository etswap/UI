...
import { JSBI, Percent, Token, CurrencyAmount, Currency, ETHER, ChainId } from '@etcswap-libs/sdk'
...
export function getBscScanLink(chainId: ChainId, data: string, type: 'transaction' | 'token' | 'address'): string {
  const prefix = `https://blockscout.com${BSCSCAN_PREFIXES[chainId] || BSCSCAN_PREFIXES[ChainId.MAINNET]}`
